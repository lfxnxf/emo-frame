...
import (
	...
	"github.com/lfxnxf/emo-frame/tpc/inf/go-upstream/config"
...
func (b *be) ReadPrefixManual(prefix string) (data map[string]string, version uint64, err error) {
	return getPrefix(b.c, prefix, 0)
}
